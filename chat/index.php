            ...
            <div class="page-content">
                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-body content-frame-body-left">
                        ...
                        <div id="chat" class="messages messages-img">
                        </div>                        
                        
                        <div class="panel panel-default push-up-10">
                            <div class="panel-body panel-body-search">
                                <div class="input-group">
									<form  style="display:table;" method="post" action="index.php">
										<input type="hidden" name="nombre" value="Rene">
										...
										<input type="text" name="mensaje" class="form-control" placeholder="Your message..." autocomplete="off"/>
